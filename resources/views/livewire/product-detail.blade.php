        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('products') }}" class="text-dark">Pilih Tasmu</a></li>
                ...
                <div class="col">
                    ...
                    <table class="table" style="border-top: hidden">
                        {{-- <tr>
                            ...
                            <td>:</td>
                            <td>
                                <img src="{{ url('assets/productcategory') }}/{{ $products->$product_categories->gambar}}" class="img-fluid width: 50">
                            </td>
                        </tr> --}}
                        <tr>
                            <td>Berat</td>
